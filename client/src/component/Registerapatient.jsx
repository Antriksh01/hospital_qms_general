...
const Registerapatient = () => {
  ...
  return (
    <>
        ...
        <Wrapper className="conatiner">
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
              <div className="form3">
                <input
                  type="text"
                  placeholder="Adhar NO/Any ID prrof"
                  style={{ border: "none" }}
                />
                <br />
                <br />
                ...
                <input
                  type="text"
                  placeholder="Payment Mode. Cash/Online/QR/UPI"
                  style={{ border: "none" }}
                />
          ...
          <div className="row">
            ...
            <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
              <div className="note">
                <label htmlFor=""></label>
                <textarea name="" id="note" cols="115" rows="6">
                  Additional Notes
                </textarea>
              </div>
            </div>
      ...
      <Button className="fotter">Register and Generate Token</Button>
    </>
  );
};
